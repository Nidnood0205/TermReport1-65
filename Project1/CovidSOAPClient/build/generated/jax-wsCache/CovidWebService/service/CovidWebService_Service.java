 ...
 * 
 */
@WebServiceClient(name = "CovidWebService", targetNamespace = "http://service/", wsdlLocation = "http://localhost:8080/CovidSOAPService/CovidWebService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName COVIDWEBSERVICE_QNAME = new QName("http://service/", "CovidWebService");
    ...
    public CovidWebService getCovidWebServicePort() {
        return super.getPort(new QName("http://service/", "CovidWebServicePort"), CovidWebService.class);
    }
    ...
    public CovidWebService getCovidWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "CovidWebServicePort"), CovidWebService.class, features);
    }
