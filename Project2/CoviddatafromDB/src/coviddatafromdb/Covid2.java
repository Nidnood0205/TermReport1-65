...
public class Covid2 implements Serializable {
    ...
    public Covid2(Integer yearnum, Integer weeknum, String province, Integer newCase, Integer totalCase, Integer newCaseExcludeabroad, Integer totalCaseExcludeabroad, Integer newDeath, Integer totalDeath, String updateDate) {
    ...
    public String toString() {
        return "coviddatafromdb.Covid2[ yearnum=" + yearnum + " ]";
    }
